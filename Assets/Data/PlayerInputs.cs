// GENERATED AUTOMATICALLY FROM 'Assets/Data/PlayerInputs.inputactions'
    ...
    public struct GameActions
    {
        ...
        public void SetCallbacks(IGameActions instance)
        {
            if (m_Wrapper.m_GameActionsCallbackInterface != null)
            {
                ...
                @Deploy.started -= m_Wrapper.m_GameActionsCallbackInterface.OnDeploy;
                @Deploy.performed -= m_Wrapper.m_GameActionsCallbackInterface.OnDeploy;
                @Deploy.canceled -= m_Wrapper.m_GameActionsCallbackInterface.OnDeploy;
                @Pan.started -= m_Wrapper.m_GameActionsCallbackInterface.OnPan;
                @Pan.performed -= m_Wrapper.m_GameActionsCallbackInterface.OnPan;
                @Pan.canceled -= m_Wrapper.m_GameActionsCallbackInterface.OnPan;
